...
- **본인 owner 학원 무제한** (ADR-023, 2026-05-24 — Slack/Linear/Notion 패턴)
- **초대 합류 학원 무제한** (강사·관리자 mobility)
...
- **분점 통합 대시보드** (다중 학원 운영자) — 여러 학원 KPI 한 화면 + 강사·학생 이동 분석 + 학원비 정산 자동화 (ADR-023)
