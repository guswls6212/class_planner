...
trade-off: anchor 가 drop lane 에 정확히 가지 않는 case 가 생기지만 visual order 항상 보존. 사용자 검증 (2026-05-16 ~ 2026-05-18) 으로 후자 우선 확정.
