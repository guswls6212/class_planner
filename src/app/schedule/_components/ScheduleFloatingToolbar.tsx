...
export default function ScheduleFloatingToolbar({
  ...
  return (
    <div
      ...
      className="fixed bottom-5 left-1/2 -translate-x-1/2 z-30 flex items-center gap-1 px-2.5 py-1.5 rounded-full bg-[var(--color-bg-secondary)]/95 backdrop-blur-md shadow-2xl border border-[var(--color-border)] max-w-[calc(100vw-2rem)] overflow-x-auto"
    >
      <button
        type="button"
        onClick={onPrev}
