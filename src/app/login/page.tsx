...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="onboarding-bg relative flex min-h-[calc(100vh-48px)] md:min-h-dvh items-center justify-center overflow-hidden px-4">
        ...
        <div className="onboarding-card p-8">
          <div className="relative">
            ...
            <div className="flex flex-col gap-3">
              {/* 구글 로그인 — frosted with amber hover glow */}
              <button
                onClick={handleGoogleLogin}
                disabled={isLoading}
                className="group relative flex min-h-[44px] w-full items-center justify-center gap-3 rounded-lg border border-white/10 bg-white/[0.04] px-4 py-3 text-sm font-medium text-white transition-all duration-150 hover:border-amber-400/40 hover:bg-white/[0.07] hover:shadow-[0_0_0_3px_rgba(251,191,36,0.1)] disabled:cursor-not-allowed disabled:opacity-50"
              >
              ...
              <button
                disabled
                title="준비 중"
                className="relative flex min-h-[44px] w-full items-center justify-center gap-3 rounded-lg border border-white/10 bg-[#FEE500]/[0.06] px-4 py-3 text-sm font-medium text-[#FEE500]/40 cursor-not-allowed"
              >
            ...
            <p className="mt-2 text-center text-[11px] text-zinc-500 leading-relaxed">
