...
// Application 및 Infrastructure 디렉토리
const appDir = path.join(__dirname, "../src/application");
const infraDir = path.join(__dirname, "../src/infrastructure");
...
// Application 및 Infrastructure 디렉토리 처리
console.log("Processing Application layer...");
walkDir(appDir);
console.log("Processing Infrastructure layer...");
walkDir(infraDir);
console.log(
  "🎉 Application & Infrastructure console log replacement completed!"
);
