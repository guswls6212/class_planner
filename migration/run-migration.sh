...
# .env.local 파일에서 환경변수 로드 (Next.js 방식)
if [ -f ".env.local" ]; then
...
# NEXT_PUBLIC_SUPABASE_URL을 SUPABASE_URL로 설정 (하위 호환성)
