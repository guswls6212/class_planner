...
- [x] Phase 3 Polish — SessionBlock `onDelete` prop + 컨텍스트 메뉴 삭제 연결 (PR#TBD)
- [x] Phase 3 Polish — ConfirmModal `useModalA11y` 마이그레이션 (Escape + focus trap) (PR#TBD)
- [x] Phase 3 Polish — LoginButton `supabase.auth.signOut()` 교체 (수동 localStorage 스크럽 제거) (PR#TBD)
...
| 2026-04-17 | Phase 3 Polish (W1) — SessionBlock onDelete, ConfirmModal useModalA11y, LoginButton signOut 교체 (PR#TBD) |
